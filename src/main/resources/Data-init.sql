...
(1, 'The Fool - Aion Zero', 'Aion Zero là "Kẻ Khởi Hành", xuất hiện ở nơi thời gian chưa chảy. Hành trình của anh đi từ sự ngây thơ ban đầu, trải qua mất mát, cám dỗ và điên loạn để đến với sự giác ngộ. Cuối cùng, anh trưởng thành không phải vì mạnh hơn, mà vì dám chấp nhận hậu quả của các lựa chọn và tiếp tục bước đi.', NULL, 'MAJOR', NULL, 0, 'LEGENDARY', 1, true, 'https://res.cloudinary.com/yukiimin-cloud/image/upload/v1/cards/major/00.webp', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(2, 'The Magician - Chronos Vale', 'Chronos là một nhà tư tưởng duy lý tin rằng thế giới có thể hiểu và sửa chữa. Sau cái chết của người yêu, ông dùng phép thuật can thiệp vào định mệnh để tìm ý nghĩa nhưng lại gây ra sự sụp đổ (The Tower). Cuối cùng, ông hy sinh và nhận ra tự do nằm ở việc chấp nhận những điều phi lý không thể hiểu.', NULL, 'MAJOR', NULL, 1, 'LEGENDARY', 1, true, 'https://res.cloudinary.com/yukiimin-cloud/image/upload/v1/cards/major/01.webp', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
(3, 'The High Priestess - Lunaria Noct', 'Lunaria sinh ra với khả năng nhìn thấy mọi kết cục. Trải qua bi kịch vì nói ra sự thật, cô chọn sự im lặng – một "lòng trắc ẩn chậm rãi". Cô giữ ký ức thay cho The Fool, để anh tự trải nghiệm và trưởng thành thay vì nói trước mọi bề.', NULL, 'MAJOR', NULL, 2, 'RARE', 1, true, 'https://res.cloudinary.com/yukiimin-cloud/image/upload/v1/cards/major/02.webp', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
