...
(2, 'customer@pixelmage.com', '$2a$10$pZVTj8enac8omlbdLgypl.2bxHHqGiqFNSr7cvMq3qWbDeoeAvzUG', 'Test User',    'LOCAL', true, true,  'https://api.dicebear.com/7.x/bottts/svg?seed=customer', 3, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)
