...
public class UserCollectionProgressController {
        ...
        public ResponseEntity<ResponseBase<List<UserCollectionProgressResponse>>> getUserProgress(
                        @RequestParam Integer customerId) {
                List<UserCollectionProgressResponse> progress = progressService.getUserProgress(customerId);
        ...
        public ResponseEntity<ResponseBase<UserCollectionProgressResponse>> getCollectionProgress(
                        @RequestParam Integer customerId,
